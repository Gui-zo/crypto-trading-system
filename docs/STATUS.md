...
Tail selection was tested and rejected (ADR-0023): it stops no liquidation, and
a regime filter misses both fatal entries because they opened from a flat market
— DOT +0.1% and XRP -1.1% against their trailing medians.
**The replay was then found to be flattering itself** and is corrected in
ADR-0024: a liquidated trade kept accruing funding to its intended exit and never
forfeited its margin. Priced properly, **no horizon pays** — 7 days −1,566,
14 days −28,297, 30 days −57,150, with two liquidations costing 58,571 against
...
tests/                      622 unit + integration + recorded contracts
